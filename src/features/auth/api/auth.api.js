...
import { clearSession, getCurrentSessionUser, isAuthenticated, setSession } from '@/storage/tokenStorage.js';
import { clearChatSession } from '@/storage/chatTokenStorage.js';
...
export function logout() {
  clearSession();
  // Chat uses its own token (see features/chat/api/chat.api.js) — clear it
  // too so it can't be reused under a different login in the same browser tab.
  clearChatSession();
}
